...
const stores = [
  ...
  {
    image: "/images/5.jpg",
    quote: "Reach your audience directly in their inbox.",
    name: "Promote offers, send updates, and drive repeat business. Keep your business top-of-mind for customers.",
  },
  {
    image: "/images/12.png",
    quote: `Your Google Business Profile is a powerful tool for attracting new customers. But are you making the most of your 5-star reputation? With a custom Google Review Plaque, you can proudly display your ratings and reviews, build instant trust, and encourage more customers to leave feedback!`,
    name: "", // Added default value to prevent issues
  },
];
